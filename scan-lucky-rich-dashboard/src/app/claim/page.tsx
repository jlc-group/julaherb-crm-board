            ...
            <>
              ...
              <div className="rounded-2xl p-4" style={{ background: '#fffbeb', border: '1.5px solid #f59e0b' }}>
                ...
                <ul className="space-y-2.5 text-[12px] text-[#7a4e00] leading-relaxed">
                  ...
                  <li className="flex gap-2">
                    <span className="flex-shrink-0">🔒</span>
                    <span>รางวัลที่ได้รับ<b>ไม่สามารถแลก ทอน เปลี่ยนเป็นเงินสด</b> หรือของรางวัลอื่นใดได้ และไม่สามารถโอนสิทธิ์ให้บุคคลภายนอกหรือนิติบุคคลอื่นใดไม่ว่ากรณีใด ๆ</span>
                  </li>
                </ul>
              </div>
