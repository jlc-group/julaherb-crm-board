            ...
            <>
              ...
              <div className="rounded-2xl p-4" style={{ background: '#fffbeb', border: '1.5px solid #f59e0b' }}>
                ...
                <ul className="space-y-2.5 text-[12px] text-[#7a4e00] leading-relaxed">
                  {verified.prizes.map((p, i) => {
                    ...
                    return (
                      <li key={i} className="flex gap-2">
                        ...
                        <span>ผู้ได้รับรางวัลทอง มูลค่า <b>{baht(v)} บาท</b> มีหน้าที่ชำระภาษีเงินได้<b>หัก ณ ที่จ่ายตามกฎหมาย ในอัตราร้อยละ 5</b> ของมูลค่ารางวัล เป็นเงิน <b className="text-[#b45309]">{baht(taxOf(p.prizeLabel))} บาท</b> โดยชำระเป็น<b>เงินสด</b> ณ วันรับรางวัล ก่อนรับมอบของรางวัล
                          <span className="block text-[11px] text-[#92600a] mt-0.5">ตามมาตรา 40(8) แห่งประมวลรัษฎากร ประกอบคำสั่งกรมสรรพากรที่ ท.ป. 4/2528 ข้อ 9(1) ซึ่งกำหนดให้รางวัลจากการชิงโชค/ประกวด/แข่งขัน ถูกหักภาษี ณ ที่จ่ายในอัตราร้อยละ 5</span>
                        </span>
                      </li>
                    )
                  })}
                  ...
                  <li className="flex gap-2">
                    <span className="flex-shrink-0">📦</span>
                    <span>ผู้ร่วมกิจกรรมต้อง<b>เก็บหลักฐานการเข้าร่วมกิจกรรม</b> ได้แก่ ของบรรจุภัณฑ์ กล่อง หลอด รวมถึงสติกเกอร์ หรือหลักฐานที่มีการสแกน QR Code เพื่อใช้เป็นหลักฐานในการรับรางวัล</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="flex-shrink-0">🔒</span>
                    <span>รางวัลที่ได้รับ<b>ไม่สามารถแลก ทอน เปลี่ยนเป็นเงินสด</b> หรือของรางวัลอื่นใดได้ และไม่สามารถ<b>โอนกรรมสิทธิ์</b>ให้บุคคลภายนอกหรือนิติบุคคลอื่นใดไม่ว่ากรณีใด ๆ
                      <span className="block text-[11px] text-[#92600a] mt-0.5">ทั้งนี้ ผู้โชคดียังคงสามารถมอบอำนาจให้ผู้อื่นมารับรางวัล<b>แทน</b>ได้ (กรรมสิทธิ์ในรางวัลยังเป็นของผู้โชคดี) ตามเงื่อนไขการมอบอำนาจข้างต้น</span>
                    </span>
                  </li>
                </ul>
              </div>
