...
> **หมายเหตุ 2026-07-01:** สถานะล่าสุด/ละเอียดกว่าอยู่ที่ [`docs/api-gap-audit.md`](./docs/api-gap-audit.md); เอกสารนี้เป็น handoff เก่าและอาจยังใช้คำว่า "จริง" รวม internal local/static อยู่
